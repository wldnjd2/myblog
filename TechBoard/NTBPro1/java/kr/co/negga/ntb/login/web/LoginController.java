...
public class LoginController {
	...
	@ResponseBody
	public HashMap<String, Object> loginWriteSub(AccountVO avo , HttpSession session , Model model,
		...
		String salt = loginService.selectAccountSalt(userId);
		...
		// ID와 PW를 비교하여 로그인 처리
		int count = loginService.selectAccountCount(avo);
